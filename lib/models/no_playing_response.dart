import 'models.dart';
/* 
Clase creada automaticamente desde quicktype, recibimos los datos y los mapeamos
*/
class NowPlayingResponse {
    ...
    Dates dates;
    int page;
    List<Movie> results;//hacemos una lista de peliculas
    int totalPages;
    int totalResults;
...
class Dates {//clase que tiene las fechas
    Dates({
